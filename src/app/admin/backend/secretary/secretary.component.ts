...
export class SecretaryComponent implements OnInit {
  ...
  goShow(){
    this.firebaseService.getSecretarys().subscribe(members =>{
  ...
  goEdit(id){
    ...
    this.firebaseService.getSecretary(id).subscribe(member=>{
  ...
  upload(event){
    if(this.id){
      this.firebaseService.getSecretary(this.id).subscribe(ad=>{
  ...
  addMember(value){
      this.firebaseService.addSecretary(value);
      this.resetFields();
      this.nextimg='';
      this.goShow();
  }
  ...
  updateMember(value){
    ...
    this.nextimg='';
    this.firebaseService.updateSecretary(this.id, value);
    this.goShow();
  }

  goDelete(id){
    let res = confirm("Are you sure about deleting this Member?");
    if(res) this.firebaseService.deleteSecretary(id);
    else return;
  }
