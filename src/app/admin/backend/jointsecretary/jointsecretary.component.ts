...
@Component({
  selector: 'app-jointsecretary',
  templateUrl: './jointsecretary.component.html',
  styleUrls: ['./jointsecretary.component.css']
})
export class JointsecretaryComponent implements OnInit {
  ...
  goShow(){
    this.firebaseService.getJointSecretarys().subscribe(members =>{
  ...
  goEdit(id){
    ...
    this.firebaseService.getJointSecretary(id).subscribe(member=>{
  ...
  addMember(value){
      this.firebaseService.addJointSecretary(value);
      this.resetFields();
      this.nextimg='';
      this.goShow();
  }
  ...
  updateMember(value){
    ...
    this.nextimg='';
    this.firebaseService.updateJointSecretary(this.id, value);
    this.goShow();
  }

  goDelete(id){
    let res = confirm("Are you sure about deleting this Member?");
    if(res) this.firebaseService.deleteJointSecretary(id);
    else return;
  }
