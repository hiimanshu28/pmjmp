...
@Component({
  selector: 'app-footer-ads',
  templateUrl: './footer-ads.component.html',
  styleUrls: ['./footer-ads.component.css']
})
export class FooterAdsComponent implements OnInit {
  ...
  goShow(){
    this.firebaseService.getFooterAds().subscribe(ads =>{
  ...
  upload1(event){
    ...
    if(this.id){
      this.firebaseService.getFooterAd(this.id).subscribe(ad=>{
  ...
  createAdvert(value){
      this.firebaseService.createFooterAd(value);
      this.resetFields();
      this.nextimg1='';
      this.nextimg2='';
      this.nextimg3='';
  ...
  updateAdvert(value){
    ...
    this.nextimg3='';
    this.firebaseService.updateFooterAd(this.id, value);
    this.goShow();
  }
  ...
  goEdit(id){
    ...
    this.firebaseService.getFooterAd(id).subscribe(ad=>{
      this.exampleForm.patchValue({
  ...
  goDelete(id){
    ...
    if(res) {
      this.firebaseService.deleteFooterAd(id);
    }
    else return;
  }
