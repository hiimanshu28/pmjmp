...
export class ProComponent implements OnInit {
  ...
  goShow(){
    this.firebaseService.getPros().subscribe(members =>{
  ...
  goEdit(id){
    ...
    this.firebaseService.getPro(id).subscribe(member=>{
  ...
  upload(event){
    if(this.id){
      this.firebaseService.getPro(this.id).subscribe(ad=>{
  ...
  addMember(value){
      this.firebaseService.addPro(value);
      this.resetFields();
      this.nextimg='';
      this.goShow();
  }
  ...
  updateMember(value){
    ...
    this.nextimg='';
    this.firebaseService.updatePro(this.id, value);
    this.goShow();
  }

  goDelete(id){
    let res = confirm("Are you sure about deleting this Member?");
    if(res) this.firebaseService.deletePro(id);
    else return;
  }
