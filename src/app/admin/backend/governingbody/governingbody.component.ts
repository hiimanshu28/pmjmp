...
@Component({
  selector: 'app-governingbody',
  templateUrl: './governingbody.component.html',
  styleUrls: ['./governingbody.component.css']
})
export class GoverningbodyComponent implements OnInit {
  ...
  goShow(){
    this.firebaseService.getGoverningBodys().subscribe(members =>{
  ...
  goEdit(id){
    ...
    this.firebaseService.getGoverningBody(id).subscribe(member=>{
  ...
  addMember(value){
      this.firebaseService.addGoverningBody(value);
      this.resetFields();
      this.nextimg='';
      this.goShow();
  }
  ...
  updateMember(value){
    ...
    this.nextimg='';
    this.firebaseService.updateGoverningBody(this.id, value);
    this.goShow();
  }

  goDelete(id){
    let res = confirm("Are you sure about deleting this Member?");
    if(res) this.firebaseService.deleteGoverningBody(id);
    else return;
  }
